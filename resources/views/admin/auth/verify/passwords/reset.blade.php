...
<div class="page-wrapper">
    ...
    @endif
                            <form action="{{ route('admin.passwords.request') }}" method="post">
                            {{ csrf_field() }}
                            <input type="hidden" name="token" value="{{ $token }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" name="password_confirmation" required"  placeholder="Confirm Password">
                                </div>
                                <button class="au-btn au-btn--block signbtnmks m-b-20" type="submit">Reset Password (Admin)</button>
