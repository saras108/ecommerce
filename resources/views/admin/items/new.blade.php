...
<ol class="breadcrumb"> <li class="breadcrumb-item"><a href="{{route('admin.root')}}">Home</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <form  action="{{route('store.save.items')}}"  name="itemsForm" id="itemsForm" method="post" enctype="multipart/form-data" >
                {{csrf_field()}}
                <div class="Tabpanelmks">
                  <div class="row">
                    <div class="col-md-9">
                     ...
                     <div class="form-group {{ $errors->first('description', 'has-error') }}">
                       <div class="row">
                           ...
                           <div class="col-md-10">
                              <textarea class="textarea" name="description" placeholder="Enter Description">{{old('description')}}</textarea>
                           </div>
                       </div>
                     </div>
                     ...
                     <div class="row">
                       ...
                       <div class="col-md-6">
                        <div class="form-group {{ $errors->first('print', 'has-error') }}">
                          ...
                          <div class="col-md-12">
                            <input type="text" class="form-control" placeholder="Print of T-shirt" name="print" value="{{old('print')}}">
                          </div>
                        </div>
                        </div>
                      </div>
                       ...
                       <div class="col-md-6">
                        <div class="form-group {{ $errors->first('color', 'has-error') }}">
                         <div class="row">
                          ...
                          <div class="col-md-12">
                            <input type="text" class="form-control" placeholder="Enter Color of T-shirt" name="color" value="{{old('color')}}">
                          </div>
                        </div>
                      </div>
                       </div>
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="row">
                             ...
                             <div class="col-md-12">
                                <select class="form-control select2" id="type" name="size" value="{{old('size')}}>
                       ...
                       <div class="col-md-6">
                         <div class="form-group {{ $errors->first('cost', 'has-error') }}">
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="Enter Cost in NRs." name="cost" value="{{old('cost')}}">
                              </div>
                            </div>
                        </div>
                       </div>
                      ...
                      <label for="image">Image</label>
                        <div class="col-sm-12">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                              ...
                              <input type="file" accept="image/*" name="photo" style="padding: 6px 0px;">
                   ...
                   <div class="col-md-12">
                    ...
                    <div class="form-group">
                          <button type="button" class=" btn-secondary" style=" padding: 5px; width: 100%" id="add_img">Add Images</button>     
                        </div>
                    </div>
            </form>
          </div>
  ...
  $("#add_here").append(' <div class="col-sm-3">'+
                            '<div class="fileinput fileinput-new" data-provides="fileinput">'+
                              '<div class="fileinput-new thumbnail" style="width: 150px; height: 150px;">'+
                                  '<img src="http://placehold.it/150x150" alt="profile pic">'+
                              '</div>'+
                              '<input type="file" accept="image/*" name="images[]" style="padding: 6px 0px;">'+
                            '</div>'+
                          '</div>');
});
</script>
