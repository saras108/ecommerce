...
<ol class="breadcrumb"> <li class="breadcrumb-item"><a href="{{route('owner.root')}}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{route('owner.list.stores')}}">Stores</a></li>
        <li class="breadcrumb-item active">Add New Stores</li>
</ol>

    <div class="row">
        <div class="col-md-12">
            <form  action="{{route('owner.save.stores')}}"  name="adminForm" id="adminForm" method="post" enctype="multipart/form-data" >
                {{csrf_field()}}
                    ...
                    <div class="col-md-9">
                      ...
                      <div class="form-group {{ $errors->first('store_name', 'has-error') }}">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="Enter Store Name" name="store_name" value="{{old('store_name')}}">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group {{ $errors->first('location', 'has-error') }}">
                          <div class="row">
                            ...
                            <div class="col-md-10">
                              <input type="text" class="form-control" placeholder="Enter Location Here" name="location" value="{{old('location')}}">
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group {{ $errors->first('citizionship', 'has-error') }}">
                            <div class="row">
                              ...
                              <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Enter Citizionship Number" name="citizionship" value="{{old('citizionship')}}">
                              </div>
                            </div>
                          </div>
