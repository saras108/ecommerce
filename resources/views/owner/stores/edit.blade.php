...
<ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            <form  action="{{route('owner.update.stores')}}"  name="adminForm" id="adminForm" method="post" enctype="multipart/form-data" >
                {{csrf_field()}}
                    ...
                    <div class="col-md-9">
                      ...
                      <div class="form-group {{ $errors->first('owner_name', 'has-error') }}">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="Enter Owner Name" name="owner_name" value="{{old('owner_name',$store->owner_name)}}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group {{ $errors->first('store_name', 'has-error') }}">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="Enter Store Name" name="store_name" value="{{old('store_name',$store->store_name)}}">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group {{ $errors->first('location', 'has-error') }}">
                          <div class="row">
                            ...
                            <div class="col-md-10">
                              <input type="text" class="form-control" placeholder="Enter Location Here" name="location" value="{{old('location',$store->location)}}">
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group {{ $errors->first('citizionship', 'has-error') }}">
                            <div class="row">
                              ...
                              <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Enter Citizionship Number" name="citizionship" value="{{old('citizionship',$store->citizionship)}}">
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="form-group {{ $errors->first('contact', 'has-error') }}">
                              <div class="row">
                                ...
                                <div class="col-md-10">
                                  <input type="text" class="form-control" placeholder="Enter Contact Number" name="contact" value="{{old('contact',$store->contact)}}">
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="form-group {{ $errors->first('email', 'has-error') }}">
                                <div class="row">
                                  ...
                                  <div class="col-md-10">
                                    <input type="email" class="form-control" placeholder="Enter E-mail Address" name="email" value="{{old('email',$store->email)}}" readonly>
                                  </div>
                                </div>
                              </div>
                                 ...
                                 <div class="row">
                                   ...
                                   <div class="col-md-10">
                                     <select class="form-control select2" id="type" name="profession">
                                       ...
                                       <option value="{{old('profession',$store->profession)}}">Activate</option>
