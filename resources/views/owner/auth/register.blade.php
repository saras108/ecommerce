...
<div class="page-wrapper">
    ...
    @endif
                            ...
                            {{ csrf_field() }}
                            <input type="hidden" name="verifyme" value="{{$verifyMe}}">
                            <input type="hidden" name="emailAdd" value="{{$emailAdd}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" id="confirm_password" placeholder="Confirm Password">
                                </div>


                                <button class="au-btn au-btn--block signbtnmks m-b-20" type="submit">Register</button>
